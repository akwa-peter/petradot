...
export default function WhatsAppWidget() {
  const phoneNumber = "+234 916 142 7809";
  ...
  return (
    ...
    >
      <div className="group relative">
        ...
        <div className="absolute inset-0 bg-green-500 rounded-full blur-lg opacity-50 group-hover:opacity-70 transition-opacity"></div>

        {/* Main button */}
        <div className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform group-hover:scale-110">
          {/* WhatsApp Icon */}
          <svg
            width="32"
            height="32"
